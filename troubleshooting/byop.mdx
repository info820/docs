...
description: "Learn how to use your existing phone numbers or Twilio account with Argentiva Ops through SIP integration or Caller ID verification"
---

## 1. Bring Your Own Number (SIP Integration)

- **Yes**: If you have a PBX or VOIP provider, you can integrate via SIP trunk.
- Inbound & outbound will flow through your existing lines, but still utilize Argentiva Ops' AI.
...
- Meanwhile, you can have the best of both worlds by provisioning Twilio-based numbers through Argentiva Ops' or using a custom approach.
