...
title: "Core Concepts"
icon: "lightbulb"
description: "Learn the fundamental building blocks of Argentiva Ops, including system prompts, voices, and AI assistants"
---

Welcome to the fundamentals of Argentiva Ops. Here, we explore the essential building blocks that you need to understand before configuring your AI assistant and calls.
...
- Argentiva Ops integrates with **ElevenLabs** voices for natural-sounding speech.
