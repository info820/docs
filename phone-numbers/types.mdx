...
icon: "phone"
description: "Learn about the different types of phone numbers you can use with Argentiva Ops: dedicated numbers, SIP integration, and Caller ID"
---

Argentiva Ops lets you connect three different kinds of phone numbers to your AI assistant:

1. **Normal (Dedicated) Numbers**
   - Rented directly from Argentiva Ops.
...
2. **SIP Integration (VOIP/PBX)**
   ...
   - This setup allows you to keep your existing numbers while benefiting from Argentiva Ops' AI.
