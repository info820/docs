...
icon: "phone-office"
description: "Learn how to integrate Argentiva Ops with your existing PBX or VOIP infrastructure through SIP trunks"
---

For businesses with existing PBX or VOIP infrastructure, Argentiva Ops can integrate through SIP trunks or direct connections:

## 1. SIP Trunk

- **How It Works**: You share your SIP credentials (server, username, password). Argentiva Ops configures a trunk internally.
...
- If your PBX already handles call routing, pass the call to Argentiva Ops only when certain conditions are met (like after IVR selection).
...
- Carrier charges from your PBX provider still apply, plus any Argentiva Ops usage fees.
