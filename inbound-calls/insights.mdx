...
After an inbound call, Argentiva Ops provides transcripts, analytics, and possible automation triggers.
...
- In your Argentiva Ops dashboard, go to **Calls** or **History**.
