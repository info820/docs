...
If you want deeper customization beyond no-code blocks, Argentiva Ops supports **webhooks** and a **REST API**.

## 1. Webhooks

- **When to Use**: Trigger events in external systems the moment something happens in Argentiva Ops (e.g., "Call Ended,").
...
**Note:** You'll find the official API reference in a dedicated docs section or via your Argentiva Ops dashboard. Always secure your tokens and test endpoints in a dev environment.