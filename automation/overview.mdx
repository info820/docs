...
description: "Learn about Argentiva Ops' built-in automation engine for creating workflows without coding"
---
...
Argentiva Ops includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside Argentiva Ops (e.g., "call ended," "inbound call context injection").
